...
pub fn model_registry() -> Vec<ModelEntry> {
    vec![
        ...
        ModelEntry {
            ...
            description: "Qwen 3.5 2B Instruct – ny modern balanserad favorit, Q4 (~1.2 GB)".to_string(),
        ...
        ModelEntry {
            ...
            description: "Qwen 3.5 4B Instruct – smart analytisk expert, Q4 (~2.6 GB)".to_string(),
        ...
        ModelEntry {
            ...
            description: "Qwen 3.5 9B Instruct – extremt kraftfull för sin storlek, Q4 (~5.3 GB)".to_string(),
        ...
        ModelEntry {
            ...
            description: "Qwen 2.5 Coder 7B – absolut världsklass på kod, logik och Excel, Q4 (~4.4 GB)".to_string(),
