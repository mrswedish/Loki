...
pub fn model_registry() -> Vec<ModelEntry> {
    vec![
        ...
        ModelEntry {
            ...
            size_bytes: 2_943_000_000,
            description: "Qwen3.5 4B – specialist på sammanfattning och mötesprotokoll, 256K kontext för långa transkriberingar, Q4 (~2.7 GB)".to_string(),
            flavor: "Sammanfattning".to_string(),
            ram_required_gb: 5.0,
            is_default: false,
        },
        ModelEntry {
        ...
        ModelEntry {
            ...
            size_bytes: 6_098_000_000,
            description: "Qwen3.5 9B – kraftfullare på strukturerade mötesprotokoll och längre sammanfattningar, 256K kontext. Kräver sänkt kontext vid < 8GB VRAM. Q4 (~5.7 GB)".to_string(),
            flavor: "Sammanfattning".to_string(),
