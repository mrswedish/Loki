...
pub fn model_registry() -> Vec<ModelEntry> {
    vec![
        ModelEntry {
            ...
            description: "Google Gemma 3n E2B – vision + ljud, Q4 (~1.7 GB)".to_string(),
        ...
        ModelEntry {
            ...
            description: "Google Gemma 3n E4B – vision + ljud, Q4 (~2.3 GB)".to_string(),
            flavor: "Vision".to_string(),
            ram_required_gb: 4.0,
            is_default: false,
        },
        ModelEntry {
            ...
            description: "Google Gemma 3 4B – djup analys, vision, Q4 (~2.5 GB)".to_string(),
