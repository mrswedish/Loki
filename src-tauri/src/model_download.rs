...
pub fn model_registry() -> Vec<ModelEntry> {
    vec![
        ...
        ModelEntry {
            ...
            description: "Google Gemma 4 12B – kraftfullast, multimodal, 256K kontext. QAT 4-bit (behåller nära originalkvalitet). Kräver ~16 GB RAM, körs på CPU om GPU-minnet inte räcker. (~6.7 GB)".to_string(),
